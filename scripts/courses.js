const courses = [
    ...
    { code: 'WDD 131', title: 'Dynamic Web Pages', credits: 3, completed: true, category: 'WDD' },
    ...
    { code: 'CSE 123', title: 'Software Engineering', credits: 3, completed: false, category: 'CSE' },
    { code: 'CSE 124', title: 'Mobile Application Development', credits: 3, completed: false, category: 'CSE' }
];
